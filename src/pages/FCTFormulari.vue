      ...
      <q-form @submit="confirmSave" @validationError="errorForm" ref="formulariAlumnes">
        ...
        <div class="q-pa-md">
          <div class="q-gutter-md row">
            ...
            <q-btn-dropdown class="q-mt-md q-mr-md q-ml-sm" color="primary" label="Lloc de treball"
        ...
        <div class="row flex justify-start q-mt-sm q-gutter-y-md">
          ...
          <div class="col-md-4">
            <q-input
              ...
              bg-color="primary"
              type="text"
              label="Nom complet representant legal"
        ...
        <div class="row flex justify-start q-mt-sm q-gutter-y-md">
          ...
          <div class="col-md-4">
            <q-input
              ...
              outlined
              type="text"
              label="Nom complet tutor empresa"
        ...
        <div class="row flex justify-center q-my-sm q-gutter-y-md">
          <div class="col-md-4  q-pl-sm">
            ...
            <div class="q-gutter-sm ">
              <q-radio v-model="formData.flexibilitzacioModulFct" checked-icon="task_alt"
                       unchecked-icon="panorama_fish_eye" :val="true" label="Si"/>
              <q-radio v-model="formData.flexibilitzacioModulFct" checked-icon="task_alt"
                       unchecked-icon="panorama_fish_eye" :val="false" label="No"/>
            </div>
